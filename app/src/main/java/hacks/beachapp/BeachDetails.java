...
public class BeachDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
//            case R.id.ivgoLeft:
//                LinearLayoutManager layoutManager = (LinearLayoutManager) rvCityDetails
//                        .getLayoutManager();
//
//                rvCityDetails.getLayoutManager().scrollToPosition(layoutManager.findFirstVisibleItemPosition() - 1);
//                break;
//            case R.id.ivgoRight:
//                LinearLayoutManager layoutManager1 = (LinearLayoutManager) rvCityDetails
//                        .getLayoutManager();
//
//                rvCityDetails.getLayoutManager().scrollToPosition(layoutManager1.findLastVisibleItemPosition() + 1);
//                break;
            case R.id.tvLearnMore:
                Intent i=new Intent(activity,MoreAboutLocation.class);
                i.putExtra("CityRecordId",CityRecordId);
                startActivity(i);
                break;
        }
    }
    ...
    private void getdetailsrooms() {
        ...
        Array_city_hotels = new LinkedList<HashMap<String, String>>();
