 ...
 */
public class ThingsToDoAdapter extends ArrayAdapter<HashMap<String, String>> {

    private final Activity context;
    private final LinkedList<HashMap<String, String>> allDataApparels;


    public ThingsToDoAdapter(Activity context, LinkedList<HashMap<String, String>> list) {
    ...
    public void initAll(View view, ViewHolder viewHolder) {
        viewHolder.tvThings = (TextView) view.findViewById(R.id.tvAmenity);
    }

    public void fillAll(final ViewHolder holder, final int position) {
        try {
            holder.tvThings.setText(allDataApparels.get(position).get("Title"));
