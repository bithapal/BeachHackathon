...
public class RecyclerImageAdapter extends RecyclerView.Adapter<RecyclerImageAdapter.ViewHolder> {
    ...
    public RecyclerImageAdapter(Context context, LinkedList<HashMap<String, String>> list) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        try {
            final String img = "http://images.hacks.com//CITY/"+allData.get(position).get("CityRecordId")+"/"+allData.get(position).get("Photo");
