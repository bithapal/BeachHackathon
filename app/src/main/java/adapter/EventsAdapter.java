...
public class EventsAdapter extends ArrayAdapter<HashMap<String, String>> implements Animation.AnimationListener {
    ...
    public EventsAdapter(Activity context, LinkedList<HashMap<String, String>> list) {
        super(context, R.layout.events_item, list);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflator.inflate(R.layout.events_item, null);
            final AllItemsAdapter.ViewHolder viewHolder = new AllItemsAdapter.ViewHolder();
            initAll(view, viewHolder);
            view.setTag(viewHolder);

        }
        AllItemsAdapter.ViewHolder holder = (AllItemsAdapter.ViewHolder) view.getTag();
        fillAll(holder, position);
        return view;
    }

    public void initAll(View view, AllItemsAdapter.ViewHolder viewHolder) {
    ...
    public void fillAll(final AllItemsAdapter.ViewHolder holder, final int position) {
        try {
